...
import { N, NodeList, E, EReg, List, Any, Seq, SetAny, GBase, opt, list, sure, _any } from './grammar2';
...
@List(Stm, null, 0) export class Stms extends NodeList { }
...
@Seq(Id, opt(Generics)) export class IdWithGenerics extends N { constructor(e:E, public generics:Generics) { super(e); } }
...
@Seq(Expr1, list(Access, null, 0)) export class Expr2 extends N { constructor(e:E, public expr:Expr1, public parts:Access[]) { super(e); } }
...
@Seq('else', sure(), Stm) export class Else extends N { constructor(e:E, public stm:Stm) { super(e); } }
class _If extends N { constructor(e:E, public expr:Expr, public stm:Stm, public _else:Else) { super(e); } }
...
@Seq('while', sure(), '(', Expr, ')', Stm) export class While extends N { constructor(e:E, public expr:Expr, public stm:Stm) { super(e); } }
...
class _ClassType extends N { constructor(e:E, public name:IdWithGenerics, body:Stm) { super(e); } }
...
@Seq(opt('lazy'), 'var', sure(), list(VarDecl, ',', 1), ';') export class Vars extends N { constructor(e:E, public vars:VarDecl[]) { super(e); } }

@Seq('=>', sure(), Expr, ';') export class FunctionBody1 extends N { }
@Seq('function', sure(), IdWithGenerics, '(', FuncArgs, ')', _any(FunctionBody1, Stm))
export class Function extends N { constructor(e:E, public name:IdWithGenerics, public args:FuncArgs, body:FunctionBody1|Stm) { super(e); } }
